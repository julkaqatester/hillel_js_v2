...
// Для того, щоб створити його потрібно виділити сроки та нажати сtrl + /
...
/* 
   ...
   Для того, щоб створити його потрібно виділити сроки та нажати alt + shift + a /
 */
...
//let first_name = "John"; // Погано
//let firstName = "John"; // Добре
...
//У фактичності цей код виглядає так:
...
console.log(message); // Вихід: "Вітаємо на курсі, АННА!" */
...
// console.log(num, typeof number); // Результат: 42 (тип: number)
...
Оператор typeof 
https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Operators/typeo
