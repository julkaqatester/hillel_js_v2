...
/* --- switch ---
У JavaScript switch - це інструкція для умовного розгалуження коду, яка дозволяє вибрати один з численних блоків коду для виконання на основі значення виразу. 
switch особливо корисний, коли потрібно зробити велику кількість варіантів у випадку, коли змінна приймає різні значення.
*/
